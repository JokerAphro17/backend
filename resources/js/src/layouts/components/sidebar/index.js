    ...
    return (
        <>
            <div class="min-h-screen bg-gray-100">
                <div class="sidebar min-h-screen w-[3.35rem] bg-indigo-200 overflow-hidden border-r hover:w-56 hover:bg-white hover:shadow-lg">
                    <div class="flex flex-col w-60 h-screen py-8 border-r dark:bg-gray-800 dark:border-gray-600">
                        ...
                        <div class="flex flex-col justify-between flex-1 mt-6">
                            <nav>
                                ...
                                <a
                                    class="flex items-center px-4 py-2 text-gray-700 bg-gray-200 dark:bg-gray-700 dark:text-gray-200"
                                    href="#"
                                >
                                    <svg
                                        class="w-5 h-5"
                                ...
                                >
                                    ...
                                    <span class="mx-4 font-medium">Coupon</span>
                                </a>
