    ...
    return (
        <>
            <div className="min-h-screen bg-gray-100">
                <div className="sidebar min-h-screen w-[3.35rem] bg-indigo-200 overflow-hidden border-r hover:w-56 hover:bg-white hover:shadow-lg">
                    <div className="flex flex-col w-60 h-screen py-8 border-r dark:bg-gray-800 dark:border-gray-600">
