...
import { API_STORAGE_URL, USER_SESSION } from '../../../../utilities/constant';
                ...
                {useConnect?.uuid !== formProfile?.uuid && !isLoading ? (
                    <Button className='mr-2'
                        ...
                        {formProfile?.restriction ? (
                            <><i class="zmdi zmdi-check"></i> Déverrouiller</>
                        ) : (
                            <><i class="zmdi zmdi-block"></i> Verrouiller</>
                        )} le compte
                    </Button>
                ) : null}
                        ...
                        <div className='wideget-user-contact mt-4'>
                            <div className="media mb-5 mt-0">
                                <div className="d-flex mr-3">
                                    <span className="user-contact-icon bg-dark"><i class="zmdi zmdi-accounts text-white"></i></span>
                                </div>
